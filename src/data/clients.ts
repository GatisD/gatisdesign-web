...
export const clientLogos: ClientLogo[] = [
  ...
  { slug: "laluna", name: "Laluna", width: 280, height: 55 },
  { slug: "nervostrong-veikals", name: "Nervostrong Medica", width: 272, height: 72 },
  { slug: "profdurys", name: "Prof Durys", width: 109, height: 72 },
  { slug: "psl", name: "PSL", width: 125, height: 72 },
  { slug: "salonsobjekts", name: "Salons Objekts", width: 210, height: 72 },
  { slug: "chipchop", name: "ChipChop Barbershop", width: 61, height: 72 },
  { slug: "8kajis", name: "8kājis", width: 159, height: 72 },
  { slug: "minismaidins", name: "MiniSmaidiņš", width: 94, height: 72 },
