...
export const dict = {
  lv: {
    ...
    error: {
      ...
      body: "Lapu neizdevās parādīt līdz galam. Pārlādē to vai sāc no sākumlapas. Ja tas atkārtojas, uzraksti man un pievieno tehnisko ziņu no šīs lapas - tā palīdz atrast cēloni.",
      reload: "Pārlādēt lapu",
      home: "Uz sākumu",
      write: "Rakstīt par kļūdu",
      details: "Tehniskā ziņa",
      unknown: "Nezināma kļūda",
      mailSubject: "Kļūda vietnē gatisdesign.com",
    },
    cookies: {
    ...
    form: {
      ...
      errors: {
        ...
        turnstile: "Robotu pārbaudi neizdevās pabeigt. Mēģini vēlreiz pēc brīža.",
        turnstileUnavailable: "Robotu pārbaude īslaicīgi nav pieejama. Mēģini pēc dažām minūtēm.",
      },
    },
  },
  en: {
    ...
    error: {
      ...
      body: "The page could not be shown in full. Reload it or start from the homepage. If it happens again, write to me and include the technical message from this page - it helps find the cause.",
      reload: "Reload the page",
      home: "Go to homepage",
      write: "Report the error",
      details: "Technical message",
      unknown: "Unknown error",
      mailSubject: "Error on gatisdesign.com",
    },
    cookies: {
    ...
    form: {
      ...
      errors: {
        ...
        turnstile: "The bot check did not finish. Try again in a moment.",
        turnstileUnavailable: "The bot check is temporarily unavailable. Try again in a few minutes.",
      },
    },
  },
} as const;
