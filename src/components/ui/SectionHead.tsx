...
export default function SectionHead({
  ...
  title: ReactNode;
  lede?: ReactNode;
  /** Virsraksta id, lai sekcija to var norādīt ar aria-labelledby. */
  id?: string;
}) {
  return (
    <div className="mb-[clamp(38px,5vw,64px)] grid gap-[18px] lg:grid-cols-[minmax(0,1fr)_minmax(0,38ch)] lg:items-end lg:gap-11">
      <div>
        ...
        <h2
          id={id}
          className="text-[clamp(1.95rem,4.1vw,3.35rem)] font-light leading-[1.06] tracking-[-0.038em] [text-wrap:balance] max-w-[20ch]"
        >
          {title}
        </h2>
      </div>
