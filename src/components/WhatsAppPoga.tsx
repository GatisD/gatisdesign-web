 ...
 *
 * Uz dzeltenā pildījuma ikona un teksts ir tumši (#1A1206, 9,50:1). Balts uz
 * zaļā būtu 1,73:1 - tas nav lasāms nemaz.
 *
  ...
  return (
    <a
      ...
      className={[
        ...
        "bg-amber pe-0 ps-0 text-on-amber [box-shadow:0_10px_30px_-12px_rgb(30_215_96_/_0.55)]",
